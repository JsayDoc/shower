define({ "api": [
      ...
      "fields": {
        "Response": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "last_achievement.achievement.image_watch",
            "description": "<p>Иконка часов</p>"
          },
          {
            "group": "Response",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "daily_active.achievement.image_watch",
            "description": "<p>Иконка часов</p>"
          },
          {
            "group": "Response",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "wellness_fountain.achievement.image_watch",
            "description": "<p>Иконка часов</p>"
          },
          {
            "group": "Response",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "wasted_water.achievement.image_watch",
            "description": "<p>Иконка часов</p>"
          },
          {
            "group": "Response",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "single_achievements.achievement.image_watch",
            "description": "<p>Иконка часов</p>"
          },
          {
            "group": "Response",
  ...
  },
  {
    "type": "post",
    "url": "profile/:url/",
    "title": "Создать одиночное достижение",
    "success": {
      "examples": [
        {
    ...
    "group": "Душ_и_достижения",
    "description": "<p>Варианты <code>:url</code>, <code>invitation</code> - Приглашение, <code>reviewer</code> - Рецензент, <code>first_chat</code> - Первое знакомство, <code>push_notification</code> - Предупрежден-вооружен, <code>dj_booth</code> - Кабинка ди-джея</p>",
      ...
      "fields": {
        "Response": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "mood",
            "description": "<p>Настроение <code>True</code> - можно добавить, <code>False</code> - нельзя добавлять, уже существует</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "core/get/music/files/",
    "title": "Музыка в приложении",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "[\n    {\n        \"music_files\": [\n            {\n                \"title\": \"TEST\",\n                \"file\": \"http://127.0.0.1:8000/media/core/music/test.mp3\"\n            },\n            {\n                \"title\": \"TEST2\",\n                \"file\": \"http://127.0.0.1:8000/media/core/music/test2.mp3\"\n            }\n        ]\n    }\n]",
          "type": "json"
        }
      ],
      "fields": {
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "{\n    \"billing\": true,\n    \"subscription\": {\n        \"expiry_date\": 1663748582,\n        \"status\": true,\n        \"method\": \"2\",\n        \"type\": \"subscription.yearly\",\n        \"renewal\": true\n    },\n    \"maintenance\": true,\n    \"maintenance_title\": \"Заголовок технических работ\",\n    \"maintenance_text\": \"Текст технических работ\",\n    \"check_email\": false,\n    \"check_full_info\": false,\n    \"course\": {\n        \"missed\": 0,\n        \"end\": 28\n    },\n    \"remove_date\": null,\n    \"single_achievements\": [\n        {\n            \"achievement\": {\n                \"users_percent\": 50,\n                \"achievement_type\": \"reviewer\",\n                \"image\": null,\n                \"image_watch\": null,\n                \"title\": \"Ну как водичка?\",\n                \"slug\": \"nu-kak-vodichka\",\n                \"duration\": 1,\n                \"description\": \"Вы оставили отзыв о JSay Shower\",\n                \"text\": \"Без вашего экспертного мнения просто не обойтись! Мы серьезно.\",\n                \"name\": \"Мной оставлен отзыв о приложении JSay Shower!\",\n                \"repeat\": false\n            },\n            \"progress\": 22,\n            \"completed\": true,\n            \"users_percent\": 0,\n            \"complete_date\": \"2022-12-14T22:48:19Z\",\n            \"viewed\": false,\n            \"version\": 1\n        }\n    ]\n}",
          "type": "json"
        }
      ],
      "fields": {
